...
XARM_CLIENT_SCRIPT = OPENPI_ROOT / "src" / "xarm6_control" / "cli" / "main.py"
...
wrist_camera = ZmqCameraBackend(host="127.0.0.1", port=5000, img_size=None, name="wrist", target_fps=15.0)
base_camera = ZmqCameraBackend(host="127.0.0.1", port=5001, img_size=None, name="base", target_fps=15.0)
